<?php
/*
// "Simple Image Rotator" Module for Joomla! 1.0.x - Version 1.1
// License: http://www.gnu.org/copyleft/gpl.html
// Authors: Fotis Evangelou - George Chouliaras
// Copyright (c) 2006 - 2007 JoomlaWorks.gr - http://www.joomlaworks.gr
// Project page at http://www.joomlaworks.gr - Demos at http://demo.joomlaworks.gr
// ***Last update: April 18th, 2007***
*/
...
<?php } ?>
ul#jw-sir li#jw-sir-loading {background:<?php if ($darkbg) {echo '#000';} else {echo '#fff';} ?> url(modules/mod_jw_sir/loading<?php if ($darkbg) {echo '_black';} ?>.gif) no-repeat center;width:<?php echo $width; ?>px;height:<?php echo $height; ?>px;}
</style>
