...
//$configArray['siteUrl'] = trim( mosGetParam( $_POST, 'siteUrl', $ConfigManager->config['live_site'] ) );
// Site URL is not preserved, since it will definetely change when the site is moved to another host
