...
if (!isset($SAJAX_INCLUDED)) {
	...
	// $sajax_remote_uri = $mosConfig_live_site . "/administrator/index2.php?option=com_jpack&no_html=1&act=ajax";
	$sajax_remote_uri = sajax_get_my_uri();
	...
	function sajax_get_common_js() {
		...
		function sajax_do_call(func_name, args) {
			...
			uri = "<?php echo sajax_get_my_uri() . "?option=com_jpack&no_html=1&act=ajax"; ?>";
