...
/**
 * NKD: If a configuration.php exists, copy it to this directory and kill the original. This
 * allows us to use a pre-existing configuration.php as a template for restoring a site's backup
 */
