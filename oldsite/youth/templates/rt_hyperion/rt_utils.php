...
$leftcolumn_width = (mosCountModules('left')>0 or (isset($subnav) and $subnav->ismenu() and $splitmenu_col=="leftcol")) ? $leftcolumn_width : "0";
$rightcolumn_width = (mosCountModules('right')>0 or (isset($subnav) and $subnav->ismenu() and $splitmenu_col=="rightcol")) ? $rightcolumn_width : "0";
$inset_width = (mosCountModules('inset')>0) ? $inset_width : "0";
