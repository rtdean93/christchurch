...
<!-- BEGIN previous_month_link_row -->
      	...
      	<img src='$mosConfig_live_site/components/com_extcalendar/images/mini_arrowleft.gif' border='0' alt="{PREVIOUS_MONTH}" align='absmiddle' hspace='5'>
      	{PREVIOUS_MONTH}</a>
<!-- END previous_month_link_row -->
      	...
      	{NEXT_MONTH}
      	<img src='$mosConfig_live_site/components/com_extcalendar/images/mini_arrowright.gif' border='0' alt="{NEXT_MONTH}" align='absmiddle' hspace='5'>
      	</a>
			</td>
		</tr>
<!-- END navigation_row -->
...
<!-- BEGIN info_row -->
		<tr>
			<td class='tablec' colspan='2'>
				<img src='{$CONFIG_EXT['calendar_url']}themes/default/images/icon-info.gif' align='absmiddle'>&nbsp;<strong>{INFO}</strong>
			</td>
		</tr>
		<tr>
			<td class='tableb' colspan='2'>
...
<!-- BEGIN admin_row -->
		...
		<tr>
			<td class='tableb' colspan='2'>
				<input name="Administrator" type="checkbox" value="1" {Administrator_CHK} >{Administrator_LABEL}
			</td>
		</tr>
		<tr>
			<td class='tableb' colspan='2'>
...
<!-- BEGIN message_row -->
		<tr class="tableb">
			...
			<input type='text' name='extcal_search' class='textinput' value="{KEY_VAL}" onFocus="if(this.value == '{KEY_DESC}') this.value='';" onBlur="if(!this.value) this.value = '{KEY_DESC}';" size='45'>
			</td>
		</tr>
<!-- END message_row -->
<!-- BEGIN submit_row -->
			...
			<table width='100%' cellpadding='0' cellspacing='0' border='0'>
				<tr>
					<td width='6' bgcolor='{BG_COLOR}'>
						<img src='$mosConfig_live_site/components/com_extcalendar/images/spacer.gif' width='6' height='{CATEGORY_COLOR_SPACER_IMAGE_HEIGHT}'>
					</td>
...
<!-- BEGIN result_row -->
		<tr class="tableb" height="30">
			<td class='tableb' colspan="2" valign='middle'>
				<img src='$mosConfig_live_site/components/com_extcalendar/images/spacer.gif' width='1' height='8'><br />
...
<!-- BEGIN result_row -->
		<tr>
			...
			<table width='100%' cellpadding='0' cellspacing='0' border='0'>
				<tr>
					<td width='6' bgcolor='{BG_COLOR}'>
						<img src='$mosConfig_live_site/components/com_extcalendar/images/spacer.gif' width='6' height='25'>
					</td>
...
<!-- BEGIN result_row -->
		<tr class="tableb">
			<td width="80%" nowrap class="tableb">
				...
				<img src='$mosConfig_live_site/components/com_extcalendar/images/spacer.gif' width='1' height='5'><br />
...
<!-- BEGIN today_row -->
				<td bgcolor="{COLOR}" width='5' height='5' style='border: 1px solid #FFFFFF'>
					<img src="$mosConfig_live_site/components/com_extcalendar/images/spacer.gif" width="5" height="5">
				</td>
		...
		<tr>
			<td width="90%" nowrap>
				<table width='100%' cellpadding='0' cellspacing='0' border='0'>
					<tr>
						<td width='6' bgcolor='{BG_COLOR}'>
							<img src='$mosConfig_live_site/components/com_extcalendar/images/spacer.gif' alt="{CAT_NAME}" width='6' height='40'>
						</td>
...
function theme_admin_menu() {
  ...
  $returnstring = '';
  if (has_priv("Administrator") && ($event_mode != 'view')) {
...
function theme_view_event(&$event, $is_popup = false) {
    ...
    global $template_event_view, $database, $my, $lang_event_view, $lang_general, $lang_date_format, $lang_add_event_view, $CONFIG_EXT, $REFERER, $THEME_DIR;
		...
		$edit_link = has_priv($CONFIG_EXT['who_can_edit_events'])?$edit_link_URL."<img src='".$CONFIG_EXT['calendar_url']."themes/default/images/icon-editevent.gif' alt='".$lang_event_view['edit_event']."' hspace='2' border='0'></a>":"";
		...
		$delete_link = has_priv($CONFIG_EXT['who_can_delete_events'])?$delete_link_URL."<img src='".$CONFIG_EXT['calendar_url']."themes/default/images/icon-delevent.gif' alt='".$lang_event_view['delete_event']."' hspace='2' border='0'></a>":"";
...
function theme_monthly_view($date, &$results, &$info_data)
{
	...
	if (has_priv($CONFIG_EXT['who_can_add_events'])) {
    ...
    for ($i=1-$firstday;$i<=count($results);$i+=7)
    {
		...
		if ($CONFIG_EXT['popup_event_mode'])
        {
          ...
          $event_list .= "status=no,menubar=no,scrollbars=yes,resizable=no',".$CONFIG_EXT['popup_event_width'].",".$CONFIG_EXT['popup_event_height'].",false)\">";
        } else {
...
function theme_mini_cal_view($date, &$results, &$info_data)
{
    ...
    for ($i=1-$firstday;$i<=count($results);$i+=7)
    {
		...
		if(!$CONFIG_EXT['add_event_view'] || !has_priv($CONFIG_EXT['who_can_add_events']) && !has_priv('Administrator')) template_extract_block($footer_row, 'add_event_row');
...
function theme_user_profile_form($target, $extmode, $form) {
/* Display user form */
	
	global $CONFIG_EXT, $template_user_profile_form, $THEME_DIR, $errors, $lang_user_profile_data, $lang_general;
...
/* Display user form */
	...
	global $CONFIG_EXT, $template_user_registration_form, $THEME_DIR, $errors, $zone_stamp, $lang_user_registration_data, $lang_general;
	...
	$params = array(
		...
		'{TERMS_MSG}' => str_replace("%s", $CONFIG_EXT['app_name'], $lang_user_registration_data['terms_message']),
...
function theme_admin_view_event(&$result, $is_popup = false) {
    ...
    global $template_event_view, $database, $my, $lang_event_admin_data, $lang_general, $lang_date_format, $CONFIG_EXT, $REFERER, $THEME_DIR;
		...
		$delete_link = has_priv("Administrator")?"<a href='".$sef_href."' onClick=\"return verify('".$lang_event_admin_data['delete_confirm']."')\"><img src='".$CONFIG_EXT['calendar_url']."themes/default/images/icon-delevent.gif' alt='".$lang_event_admin_data['delete_event']."' hspace='2' border='0'></a>":"";
		$sef_href = sefRelToAbs( $CONFIG_EXT['calendar_calling_page']."&amp;extmode=event&amp;event_mode=edit&amp;extid=".$result['extid'] );
		$edit_link = has_priv("Administrator")?"<a href='".$sef_href."'><img src='".$CONFIG_EXT['calendar_url']."themes/default/images/icon-editevent.gif' alt='".$lang_event_admin_data['edit_event']."' hspace='2' border='0'></a>":"";
...
function theme_main_menu()
{
	...
	if ((!$CONFIG_EXT['add_event_view'] || !has_priv($CONFIG_EXT['who_can_add_events'])) && !has_priv('Administrator')) template_extract_block($template_main_menu1, 'add_event');
